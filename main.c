...
// Funciones para la carga y guardado de imágenes
void cargarImagen(int *imagen, int width, int height);
void guardarImagen(int *imagen, int width, int height);

// Función para aplicar un filtro simple (paralelizada con OpenMP)
void aplicarFiltro(int *imagen, int *imagenProcesada, int width, int height);

// Función para calcular la suma de los píxeles (paralelizada con OpenMP)
...
// Aplicar filtro usando paralelización con OpenMP
void aplicarFiltro(int *imagen, int *imagenProcesada, int width, int height) {
...
// Calcular suma de píxeles usando paralelización con OpenMP
int calcularSumaPixeles(int *imagen, int width, int height) {
    int suma = 0;
